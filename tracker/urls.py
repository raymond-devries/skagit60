...
urlpatterns = [
    ...
    path(
        "trip_report_view/<int:pk>",
        TripReportDetail.as_view(),
        name="trip_report_detail",
    ),
    path("create_trip_report", TripReportCreate.as_view(), name="trip_report_create"),
    path(
        "create_trip_report/<int:peak_id>",
        TripReportCreate.as_view(),
        name="trip_report_create_peak",
    ),
    path("trip_report/<int:pk>", TripReportUpdate.as_view(), name="trip_report_update"),
    path(
        "delete_trip_report/<int:pk>",
        TripReportDelete.as_view(),
        name="trip_report_delete",
    ),
